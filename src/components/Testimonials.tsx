    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-br from-card-bg to-gray-800 rounded-3xl p-8 md:p-12 border border-gray-700 shadow-2xl overflow-hidden">
            {/* Quote Icon */}
          ...
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 bg-gray-800/80 hover:bg-neon-green/20 border border-gray-700 hover:border-neon-green/50 rounded-full p-3 text-white hover:text-neon-green transition-all duration-300 backdrop-blur-lg"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={nextTestimonial}
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-gray-800/80 hover:bg-neon-green/20 border border-gray-700 hover:border-neon-green/50 rounded-full p-3 text-white hover:text-neon-green transition-all duration-300 backdrop-blur-lg"
          >
