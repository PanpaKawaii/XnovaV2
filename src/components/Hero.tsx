...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-dark-bg via-gray-900 to-card-bg"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-slide-up">
            <div className="flex items-center justify-center lg:justify-start space-x-2 mb-6">
              ...
              <span className="text-gray-300 text-sm">Trusted by 10,000+ players</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-gray-800">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm">Premium Fields</div>
              </div>
              <div className="text-center">
          ...
          <div className="relative animate-fade-in">
            <div className="relative z-10 bg-gradient-to-br from-card-bg to-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-700">
              <div className="absolute top-4 right-4 bg-neon-green text-dark-bg px-3 py-1 rounded-full text-sm font-semibold">
                Live
              </div>
              
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">Next Available Slot</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-neon-green/10 rounded-xl p-4 border border-neon-green/20">
                  ...
                  <div className="text-white text-2xl font-bold">6:00 PM</div>
                  <div className="text-gray-400 text-sm">2 hours</div>
                </div>
              ...
              <div className="bg-gray-700/50 rounded-xl p-4 mb-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-gray-300">Players Needed</span>
